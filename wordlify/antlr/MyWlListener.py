...
'        {0} = {0}[:-1]'.format(ctx.value_or_id()[0].getText()),
'    if "/" in {}:'.format(ctx.value_or_id()[0].getText()),
'        v{0} = {1}[:{1}.rfind("/")+1]'.format(self.var_nr, ctx.value_or_id()[0].getText()),
'',
...
'        quit()',
'    os.replace({}, v{})'.format(ctx.value_or_id()[0].getText(), self.var_nr),
