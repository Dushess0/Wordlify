...
public interface WordlifyListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link WordlifyParser#double_comparsion}.
	 * @param ctx the parse tree
	 */
	void enterDouble_comparsion(WordlifyParser.Double_comparsionContext ctx);
	/**
	 * Exit a parse tree produced by {@link WordlifyParser#double_comparsion}.
	 * @param ctx the parse tree
	 */
	void exitDouble_comparsion(WordlifyParser.Double_comparsionContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link WordlifyParser#array_append}.
	 * @param ctx the parse tree
	 */
	void enterArray_append(WordlifyParser.Array_appendContext ctx);
	/**
	 * Exit a parse tree produced by {@link WordlifyParser#array_append}.
	 * @param ctx the parse tree
	 */
	void exitArray_append(WordlifyParser.Array_appendContext ctx);
	/**
	 * Enter a parse tree produced by {@link WordlifyParser#array_elem}.
	 * @param ctx the parse tree
	 */
	void enterArray_elem(WordlifyParser.Array_elemContext ctx);
	/**
	 * Exit a parse tree produced by {@link WordlifyParser#array_elem}.
	 * @param ctx the parse tree
	 */
	void exitArray_elem(WordlifyParser.Array_elemContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link WordlifyParser#length}.
	 * @param ctx the parse tree
	 */
	void enterLength(WordlifyParser.LengthContext ctx);
	/**
	 * Exit a parse tree produced by {@link WordlifyParser#length}.
	 * @param ctx the parse tree
	 */
	void exitLength(WordlifyParser.LengthContext ctx);
	/**
